console.log("Editar Producto esta conectado!!!")
...
window.onload = function(){
    console.log("estamos llegando")
        ...
        let errores = {}    
        let errorGral = false;
        const elementForm = $getId('editProductForm').elements
        ...
        $getId('editar_Guardar').addEventListener('click', function (event) {
                ...
                for (let i=0; i< elementForm.length-1; i++){
                        ...
                        $getId("msg_editProductForm").innerHTML = "Aun hay campos sin completar"
                        errorGral=true
                    } else{
                        errorGral=false
                        $getId("msg_editProductForm").innerHTML = "Aun hay campos sin completar"
